...
<div>
    <div id="wowslider-container1">
        <div class="ws_images"><ul>
                <li><img src="data1/images/image3.jpg" alt="header" title="header" id="wows1_0"/></li>
                <li><a href="http://wowslider.com/vi"><img src="data1/images/header.jpg" alt="javascript slider" title="1_01" id="wows1_1"/></a></li>
...
<div class="nav-bar">
    <ul id="menu">
        ...
        <li><a href="signup.php">Public Sign Up</a></li>
        <li> <a href="user_login.php">User Login</a>
        </li>
        <li> <a href="emp_login.php">Employee login</a>
        </li>
