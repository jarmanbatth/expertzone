<html>
<head>
    <title>Recover Password Employee</title>
</head>
<body>
...
//include("class.smtp.php"); // optional, gets called from within class.phpmailer.php if not already loaded
    ...
    $query="update employee set password='".$pass."' where email='".$address."'";
    ...
    if(!$mail->Send()) {
        ...
        echo "Message sent!";
        header("location:confirm_employee_recover.php");
    }
}
else
{
    header("location:recover_pass_employee.php?q=1");
}
?>
