...
<div>
    <div id="wowslider-container1">
        <div class="ws_images"><ul>
                ...
                <li><a href="http://wowslider.com/vi"><img src="data1/images/image3.jpg" alt="javascript slider" title="1_01" id="wows1_1"/></a></li>
...
<div class="nav-bar">
    <ul id="menu">
        ...
        <li><a href="user_view_article.php">View Article</a></li>
        <li> <a href="user_change_password.php">Change Password</a></li>
        <li> <a href="logout.php?q=user">Logout</a>
        </li>
